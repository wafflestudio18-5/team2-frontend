...
const Story = ({ showModal, reachScrollCheckPoint, story, storyinfo, userinfo, tag, logged_in, me, ResponseOpen, setResponseOpen }) => {
    ...
    return (
        <StoryStyle>
            ...
            <Main reachScrollCheckPoint={reachScrollCheckPoint} story={story} tag={tag} storyinfo={storyinfo} userinfo={userinfo} setOpen={setResponseOpen} />
            <Response IsOpen={ResponseOpen} setOpen={setResponseOpen} Response={SampleResponse} me={me} />
        </StoryStyle>
    );
};
